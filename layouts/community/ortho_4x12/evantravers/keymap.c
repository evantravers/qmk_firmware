...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SHORTCUTS] = LAYOUT_ortho_4x12_wrapper(
    ...
    _______, _______________SHORTCUTS_L3________________, _______, KC_1,    KC_2,    KC_3,    _______, KC_TAB,
    _______, _______, _______, _______, _______, KC_SPC,  _______, KC_0,    KC_DOT,  _______, _______, _______
  ),
};
